...
Dipakai untuk target Skilled/Bintang 4.

Contoh:
python modelling_tuning.py --data_dir namadataset_preprocessing --target_col target
...
def main():
    ...
    X_train, X_test, y_train, y_test, target_col = load_train_test(args.data_dir, args.target_col)
    ...
    with mlflow.start_run(run_name="RandomForest-Tuning-ManualLogging"):
        ...
        # Manual logging: params, metrics, model, artifacts.
        ...
        artifact_dir = save_artifacts(best_model, X_test, y_test, y_pred, Path("artifacts"))
        ...
        print("Untuk serving contoh:")
        print(f"mlflow models serve -m runs:/{run.info.run_id}/model -p 5001 --no-conda")
